...
#define GYRO_Sensitivity_Range_250 131.0 // LSB/(�/s)
#define GYRO_Sensitivity_Range_500 65.5  // LSB/(�/s)
#define GYRO_Sensitivity_Range_1000 32.8 // LSB/(�/s)
#define GYRO_Sensitivity_Range_2000 16.4 // LSB/(�/s)
